    ...
    <footer className="main-footer">
      <div className="footer-top-row">
        ...
        <div className="footer-col brand-col" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
          <a href="#" className="footer-brand-logo" style={{ display: 'block', marginBottom: '-18px' }}>
          ...
          <p className="footer-tagline" style={{ margin: 0, marginTop: '-15px' }}>Crafting brilliance for generations.</p>
        </div>
